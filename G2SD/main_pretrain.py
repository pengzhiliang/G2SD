...
def get_args_parser():
    ...
    parser.add_argument('--loc_weight', default=1.0, type=float)
...
def main(args):
    ...
    #dataset_train= loc_ImageNet(os.path.join(args.data_path, 'train'),args.input_size,'LOC_train_solution.csv')
    print(dataset_train)
