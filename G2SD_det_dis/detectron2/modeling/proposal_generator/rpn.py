...
class RPN(nn.Module):
    ...
    def forward(
        ...
        gt_instances: Optional[List[Instances]] = None, return_logits =False
    ):
        """
        Args:
        ...
        pred_objectness_logits_orishape = pred_objectness_logits
        ...
        if return_logits:
            return proposals, losses, pred_objectness_logits_orishape
